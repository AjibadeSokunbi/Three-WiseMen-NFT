    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public presaleAmountLimit = 6;
    uint256 public publicAmountLimit = 10;

    mapping(address => uint256) public _presaleClaimed;

    uint256 public _preSalePrice = 3300000000000000; // 0.0033 ETH
    uint256 public _ownerPrice = 0;
    uint256 public _publicPrice = 5000000000000000; // 0.005 ETH
